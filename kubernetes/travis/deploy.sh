...
openssl aes-256-cbc -K $encrypted_f0f7db0213a3_key -iv $encrypted_f0f7db0213a3_iv -in ./kubernetes/travis/susi-telegrambot-85cf0ec296e9.json.enc -out susi-telegrambot-85cf0ec296e9.json -d
mkdir -p lib
